            ...
            <form method="post" action="{{ route('post.complete_order', ['id' => $posts->id]) }}">
                ...
                <div class="form-group col-1 mb-2">
                    ...
                    <input class="form-control" style="width: 130px" type="text" name="application_day"
                        value="{{ $posts->application_day }}" style="width: 100px"; readonly>
                </div>
            ...
            @endphp --}}
                ...
                <div class="form-group col-2 mb-2">
                    ...
                    <input class="form-control" style="width: 130px" type="date" name="delivery_hope_day"
                        style="width: 125px" value="{{ $posts->delivery_hope_day }}" readonly>
                </div>
  ...
  @csrf --}}
                                ...
                                <tr class="item" readonly>
                                    ...
                                    <td>
                                        <input type="text" class="form-control" name="product_name[0]"
                                            value="{{ old('product_name', $item->product_name) }}" readonly>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control text-right" size="5"
                                            name="unit_purchase_price[0]" pattern="^[0-9]+$"
                                            value="{{ old('unit_purchase_price', $item->unit_purchase_price) }}" readonly>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control text-right" size="3"
                                            name="purchase_quantities[0]" pattern="^[0-9]+$"required
                                            value="{{ old('purchase_quantities', $item->purchase_quantities) }}" readonly>
                                    </td>
                                    <td>
                                        <input type="text" class="form-control text-right" size="3"
                                            name="units[0]" value="{{ old('units', $item->units) }}" readonly>
                                    </td>
                                    <td>
                ...
                <div class="form-group col-4 my-4">
                    ...
                    <input id="email" class="form-control choice-email" type="email"
                        value="{{ $posts->user->email }}" name="email">
                </div>
                ...
                <button type="button" class="btn btn-outline-success btn-lg" style="margin: 100px; width: 150px"
                    data-bs-toggle="modal" data-bs-target="#exampleModal">完了</button>
                ...
                <button type="button" class="btn btn-outline-danger btn-lg" style="margin: 100px; width: 150px"
                    data-bs-toggle="modal" data-bs-target="#example2Modal">差戻</button>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">発注完了</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                                <p><strong>発注完了とします。</strong>よろしいですか？</p>
                            </div>
                            <div class="modal-footer">
            ...
            <div class="modal fade" id="example1Modal" tabindex="-1" aria-labelledby="example1ModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p><strong>承認をキャンセルします。</strong>よろしいですか？</p>
                        </div>
                        <div class="modal-footer">
