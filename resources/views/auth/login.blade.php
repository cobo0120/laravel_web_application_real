...
@section('content')
    ...
    <body style="background:url({{ asset('img/workflow06.jpg') }}); background-size:cover;">
                ...
                <div class="col-md-5">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group">
                            ...
                            <a class="btn btn-link mt-3 d-flex justify-content-center webapplication-login-text"
